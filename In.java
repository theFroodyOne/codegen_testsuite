 ...
 * and Unicode hex code points 0x2028, 0x2029, 0x0085; see <tt><a href="http://www.docjar.com/html/api/java/util/Scanner.java.html">
...
public final class In {
   ...
   * <p>
   * Note that this does not create a defensive copy, so the scanner will be mutated as you read
   * on.
   */
  ...
  /**
   * Does the input have a next line? Use this to know whether the next call to {@link #readLine()}
   * will succeed. <p> Functionally equivalent to {@link #hasNextChar()}.
   */
  ...
  /**
   * Is the input empty (including whitespace)? Use this to know whether the next call to {@link
   * #readChar()} will succeed. <p> Functionally equivalent to {@link #hasNextLine()}.
   */
  ...
  /**
   * Read and return the next boolean, allowing case-insensitive "true" or "1" for true, and "false"
   * or "0" for false.
   */
